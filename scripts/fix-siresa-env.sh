...
sed -i 's/^MWL_DICOM_HOST=.*/MWL_DICOM_HOST=192.168.0.131/' .env
...
sed -i 's/192.168.0.130/192.168.0.131/g' .env
grep -q '192.168.0.131' .env || sed -i 's/^SANCTUM_STATEFUL_DOMAINS=/SANCTUM_STATEFUL_DOMAINS=192.168.0.131,/' .env
